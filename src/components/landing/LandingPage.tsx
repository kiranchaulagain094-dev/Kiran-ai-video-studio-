    ...
    <div className="min-h-screen bg-[#0a0c10] text-slate-100 flex flex-col">
      ...
      <section className="relative pt-16 pb-20 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto text-center overflow-hidden">
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <button
            id="hero-continue-google-btn"
            onClick={onContinueWithGoogle}
            className="w-full sm:w-auto px-6 py-3.5 rounded-2xl bg-[#141824] hover:bg-[#1c2233] text-white font-semibold text-sm border border-white/10 flex items-center justify-center gap-3 transition-all active:scale-95"
          >
